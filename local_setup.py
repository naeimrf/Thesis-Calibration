...
CaseName = 'ForTest_7_16_300'  # a folder_name to save input and outfile in form of pickles!
BuildNum = [i for i in range(7, 17)]  # building numbers (names) to be simulated  #  [i for i in range(7, 28)]
